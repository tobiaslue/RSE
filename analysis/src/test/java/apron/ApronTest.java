...
public class ApronTest {
	...
	public void testDomain(Manager man) throws ApronException {
		...
		Linterm0[] ltrms = { new Linterm0(1, new MpqScalar(-5)), new Linterm0(0, new Interval(0.1, 0.6)),
				new Linterm0(2, new MpfrScalar(0.1, Mpfr.RNDU)) };
		Linexpr0 linexp = new Linexpr0(ltrms, new MpqScalar(2));
		Linterm0[] ltrms2 = { new Linterm0(1, new MpqScalar(-5)), new Linterm0(0, new MpqScalar(1, 2)) };
		Linexpr0 linexp2 = new Linexpr0(ltrms2, new MpqScalar(2));
		Texpr0Node txpr = new Texpr0BinNode(Texpr0BinNode.OP_ADD,
				new Texpr0BinNode(Texpr0BinNode.OP_MUL, new Texpr0DimNode(0), new Texpr0DimNode(1)),
				new Texpr0BinNode(Texpr0BinNode.OP_DIV, new Texpr0DimNode(2), new Texpr0CstNode(new MpqScalar(2))));
		...
		Linterm1[] xltrms = { new Linterm1("z", new MpqScalar(-5)), new Linterm1("b", new Interval(0.1, 0.6)),
				new Linterm1("a", new MpfrScalar(0.1, Mpfr.RNDU)) };
		Linexpr1 xlinexp = new Linexpr1(env, xltrms, new MpqScalar(2));
		Linterm1[] xltrms2 = { new Linterm1("a", new MpqScalar(-5)), new Linterm1("z", new MpqScalar(1, 2)) };
		Linexpr1 xlinexp2 = new Linexpr1(env, xltrms2, new MpqScalar(2));
		Texpr1Node xtxpr = new Texpr1BinNode(Texpr1BinNode.OP_ADD,
				new Texpr1BinNode(Texpr1BinNode.OP_MUL, new Texpr1VarNode("a"), new Texpr1VarNode("z")),
				new Texpr1BinNode(Texpr1BinNode.OP_DIV, new Texpr1VarNode("b"), new Texpr1CstNode(new MpqScalar(2))));
		...
		try {
			System.out.println("to-gen: " + Arrays.toString(a0.toGenerator(man)));
		...
		try {
			ac2.canonicalize(man);
		} catch (NotImplementedException e) {
		}
		try {
			ac2.approximate(man, 12);
		} catch (NotImplementedException e) {
		}
		...
		assert !xempty.isTop(man);
		assert !xa0.isBottom(man);
		assert !xa0.isTop(man);
		...
		try {
			System.out.println("to-gen: " + Arrays.toString(xa0.toGenerator(man)));
		} catch (ApronException e) {
			System.out.println("got exception: " + e);
		}
		...
		assert !xa0.isEqual(man, xa1);
		assert xa0.isIncluded(man, xa1);
		assert !xa1.isIncluded(man, xa0);
		...
		try {
			xac2.canonicalize(man);
		} catch (NotImplementedException e) {
		}
		try {
			xac2.approximate(man, 12);
		} catch (NotImplementedException e) {
		}
	...
	public void variousTests() throws ApronException, CloneNotSupportedException {
		...
		System.out.println("l1 pred: " + l1.isSparse() + ", " + l1.isInteger(3) + ", " + l1.isReal(3) + ", "
				+ l1.isLinear() + ", " + l1.isQuasilinear());
		System.out.println("l2 pred: " + l2.isSparse() + ", " + l2.isInteger(3) + ", " + l2.isReal(3) + ", "
				+ l2.isLinear() + ", " + l2.isQuasilinear());
		assert l1.isEqual(l1);
		assert l2.isEqual(l2);
		assert !l1.isEqual(l2);
		assert !l2.isEqual(l1);
		...
		System.out.println("depth: " + ti.getDepth() + ", size: " + ti.getSize() + ", max: " + ti.maxDim() + ", cst: "
				+ ti.isIntervalCst() + ", lin: " + ti.isIntervalLinear() + ", poly: " + ti.isIntervalPolynomial()
				+ ", frac: " + ti.isIntervalPolyfrac() + ", scalar: " + ti.isScalar() + ", hash: " + ti.hashCode());
		System.out.println("depth: " + tn.getDepth() + ", size: " + tn.getSize() + ", max: " + tn.maxDim() + ", cst: "
				+ tn.isIntervalCst() + ", lin: " + tn.isIntervalLinear() + ", poly: " + tn.isIntervalPolynomial()
				+ ", frac: " + tn.isIntervalPolyfrac() + ", scalar: " + tn.isScalar() + ", hash: " + tn.hashCode());
		System.out.println("ti dims: " + Arrays.toString(ti.getDims()));
		System.out.println("tn dims: " + Arrays.toString(tn.getDims()));
		Texpr0Node tt = new Texpr0BinNode(Texpr0BinNode.OP_DIV, Texpr0BinNode.RTYPE_SINGLE, Texpr0BinNode.RDIR_UP,
				new Texpr0DimNode(2), new Texpr0DimNode(12));
		...
		System.out.println("lc1 pred: " + lc1.isSparse() + ", " + lc1.isInteger(3) + ", " + lc1.isReal(3) + ", "
				+ lc1.isLinear() + ", " + lc1.isQuasilinear());
		System.out.println("lc2 pred: " + lc2.isSparse() + ", " + lc2.isInteger(3) + ", " + lc2.isReal(3) + ", "
				+ lc2.isLinear() + ", " + lc2.isQuasilinear());
		System.out.println("lc3 pred: " + lc3.isSparse() + ", " + lc3.isInteger(3) + ", " + lc3.isReal(3) + ", "
				+ lc3.isLinear() + ", " + lc3.isQuasilinear());
		...
		System.out.println("ll1 pred: " + ll1.isSparse() + ", " + ll1.isInteger() + ", " + ll1.isReal() + ", "
				+ ll1.isLinear() + ", " + ll1.isQuasilinear());
		System.out.println("ll2 pred: " + ll2.isSparse() + ", " + ll2.isInteger() + ", " + ll2.isReal() + ", "
				+ ll2.isLinear() + ", " + ll2.isQuasilinear());
		assert ll1.isEqual(ll1);
		assert ll2.isEqual(ll2);
		assert !ll1.isEqual(ll2);
		assert !ll2.isEqual(ll1);
		...
		System.out.println("depth: " + tti.getDepth() + ", size: " + tti.getSize() + ", max: " + ", cst: "
				+ tti.isIntervalCst() + ", lin: " + tti.isIntervalLinear() + ", poly: " + tti.isIntervalPolynomial()
				+ ", frac: " + tti.isIntervalPolyfrac() + ", scalar: " + tti.isScalar() + ", hash: " + tti.hashCode());
		System.out.println("depth: " + ttn.getDepth() + ", size: " + ttn.getSize() + ", max: " + ", cst: "
				+ ttn.isIntervalCst() + ", lin: " + ttn.isIntervalLinear() + ", poly: " + ttn.isIntervalPolynomial()
				+ ", frac: " + ttn.isIntervalPolyfrac() + ", scalar: " + ttn.isScalar() + ", hash: " + ttn.hashCode());
		System.out.println("tti vars: " + Arrays.toString(tti.getVars()));
		System.out.println("ttn vars: " + Arrays.toString(ttn.getVars()));
		Texpr1Node ttt = new Texpr1BinNode(Texpr1BinNode.OP_DIV, Texpr1BinNode.RTYPE_SINGLE, Texpr1BinNode.RDIR_UP,
				new Texpr1VarNode("aa"), new Texpr1VarNode("zz"));
		...
		System.out.println("llc1 pred: " + llc1.isSparse() + ", " + llc1.isInteger() + ", " + llc1.isReal() + ", "
				+ llc1.isLinear() + ", " + llc1.isQuasilinear());
		System.out.println("llc2 pred: " + llc2.isSparse() + ", " + llc2.isInteger() + ", " + llc2.isReal() + ", "
				+ llc2.isLinear() + ", " + llc2.isQuasilinear());
		System.out.println("llc3 pred: " + llc3.isSparse() + ", " + llc3.isInteger() + ", " + llc3.isReal() + ", "
				+ llc3.isLinear() + ", " + llc3.isQuasilinear());
		...
		/*
		 * System.out.println(""); System.out.println("PPL Polyhedra");
		 * System.out.println("============="); testDomain(new PplPoly(false));
		 * System.out.println(""); testDomain(new PplPoly(true));
		 * System.out.println(""); System.out.println("PPL Grids");
		 * System.out.println("========="); testDomain(new PplGrid());
		 * System.out.println(""); System.out.println("Polyhedra + PPL Grids");
		 * System.out.println("====================="); testDomain(new
		 * PolkaGrid(false)); System.out.println(""); testDomain(new PolkaGrid(true));
		 */
	}
